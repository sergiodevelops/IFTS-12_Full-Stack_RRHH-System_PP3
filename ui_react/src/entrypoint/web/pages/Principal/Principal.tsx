...
export default function Principal() {
    ...
    const userIsLoggedIn = !!useSelector((state: RootState) => state?.userReducers.currentUser);
    ...
    return (
        <>
            ...
            {!sesionActiva && (existeUsuario ? <AutenticaUsuarioForm/> :
                <AltaUsuarioForm/>)}
            {!userIsLoggedIn && <SignInUpSwitch onClick={handleClick}
