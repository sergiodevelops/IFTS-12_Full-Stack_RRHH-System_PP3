export const singlePageContentList = [
    ...
    {
        title: "Visión",
        body: "Pretendemos ser la empresa elegida por nuestra calidad humana y profesional. Que nuestra experiencia, versatilidad, innovación en las soluciones de productos y servicios sean reconocidas mundialmente.",
        moduleName: "Vision",
    },
    {
        title: "Objetivo",
    ...
    {
        title: "Nosotros",
        body: "Somos un equipo de interdisciplinario que trabaja de forma personalizada y dinámica para alcanzar los objetivos de nuestros clientes.   \n" +
            "Nos encargamos de lo operativo para que te focalices en lo estratégico\n" +
            "Talento a demanda\n" +
            "Talento permanente\n" +
            "Talento tercerizado\n" +
            "Procesos de reclutamiento\n" +
            "Organización de Empleadores Profesional (PEO)\n" +
