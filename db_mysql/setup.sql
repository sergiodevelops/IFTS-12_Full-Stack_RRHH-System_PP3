...
CREATE TABLE IF NOT EXISTS `codigos_postales` (
    `id` smallint(5) unsigned NOT NULL COMMENT 'Código Postal',
...
CREATE TABLE IF NOT EXISTS `usuarios` (
    ...
    `nombre_usuario` char(20) NOT NULL COMMENT 'Alias con el que ingresa al sistema',
    `fecha_alta` date DEFAULT NULL COMMENT 'Fecha en que se dió de alta el usuario',
    PRIMARY KEY (`id`)
